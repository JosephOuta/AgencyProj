...
write.csv(datlong,"/Users/JosephOuta/Desktop/datlong.csv", row.names = FALSE)
...
testInheritedMethods() <- dplyr::select(dat_filt_log, -Kind)
...
write.csv(datr2,"/Users/JosephOuta/Desktop/datr2.csv", row.names = FALSE)

write.csv(datr,"/Users/JosephOuta/Desktop/datrorig.csv", row.names = FALSE)
