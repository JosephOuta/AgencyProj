...
df.raw %>%
  ...
  filter(!is.na(Agency2)|!is.na(NonA2)) %>% 
...
# NB: FIX THE NAMES OF COLUMNS LIKE DEBRIEF+ATTEND, ECNS BEFORE RUNNING STUDY

# Wrangle

## HERE I COMBINED GOOD AND BAD RESPONSES. IN THE FUTURE I HAVE TO SEPARATE THEM
